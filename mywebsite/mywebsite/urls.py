...
urlpatterns = [
    ...
    path('api/auth/', include('djoser.urls.jwt')), #aps the URL /api/auth to Djoser's JWT (JSON Web Token) authentication URLs. Djoser JWT provides endpoints for token-based authentication, including token issuance and refreshing.
]
